...
a.grid(True)
plt.bar(x_x-0.015,freq_pac[:,2],width = .03, color = 'green', edgecolor ='none', align='center')
plt.bar(x_x+0.015,freq_sref_bin_pac[:,2],width = .03, color = 'gold', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
...
b.grid(True)
plt.bar(x_x-0.015,freq_int[:,2],width = .03, color = 'green', edgecolor ='none', align='center')
plt.bar(x_x+0.015,freq_sref_bin_int[:,2],width = .03, color = 'gold', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
plt.ylabel('# Forecasts', fontsize = 13)
plt.xlabel('Forecast Probability',fontsize = 13)
plt.xticks(np.arange(0,1.0001,.1), fontsize = 13)
...
plt.savefig("../../../public_html/reliability_diagram_sref_arw_sref_nmb_interp_bin_percentile_85_pac_int_notable.pdf")                               
