...
freq_int_ncar = np.load('ncar_percentile_prob_int.npy')#, freq)
#Skill Score data
...
bssf_int_ncar = np.load('ncar_percentile_prob_bss_int.npy')#, bssf)
#Uncertainty data
...
pr_con75_int_ncar = np.load('ncar_sref_percentile_prob_uncertainty_con75_int.npy')#, pr_con75)
pr_unc75_int_ncar = np.load('ncar_sref_percentile_prob_uncertainty_unc75_int.npy')#, pr_unc75)
pr_con90_int_ncar = np.load('ncar_sref_percentile_prob_uncertainty_con90_int.npy')#, pr_con90)
pr_unc90_int_ncar = np.load('ncar_sref_percentile_prob_uncertainty_unc90_int.npy')#, pr_unc90)
...
freq_pac_ncar = np.load('ncar_percentile_prob_pac.npy')#, freq)
#Skill Score data
...
bssf_pac_ncar = np.load('ncar_percentile_prob_bss_pac.npy')#, bssf)
#Uncertainty data
...
pr_con75_pac_ncar = np.load('ncar_sref_percentile_prob_uncertainty_con75_pac.npy')#, pr_con75)
pr_unc75_pac_ncar = np.load('ncar_sref_percentile_prob_uncertainty_unc75_pac.npy')#, pr_unc75)
pr_con90_pac_ncar = np.load('ncar_sref_percentile_prob_uncertainty_con90_pac.npy')#, pr_con90)
pr_unc90_pac_ncar = np.load('ncar_sref_percentile_prob_uncertainty_unc90_pac.npy')#, pr_unc90)
...
a = ax1.plot(freq_int_ncar[:,0],freq_pac_ncar[:,3], linewidth = 2, c = 'blue', marker = "o", markeredgecolor = 'none')
ax1.errorbar(freq_pac_ncar[:,0],freq_pac_ncar[:,3], yerr= [abs(pr_unc75_pac_ncar[0,:,1]-freq_pac_ncar[:,3]), abs(pr_unc75_pac_ncar[0,:,2]-freq_pac_ncar[:,3])], c = 'b')
ax1.errorbar(freq_pac_ncar[:,0],freq_pac_ncar[:,0], yerr= [abs(pr_con75_pac_ncar[0,:,1]-freq_pac_ncar[:,0]), abs(pr_con75_pac_ncar[0,:,2]-freq_pac_ncar[:,0])], c = 'b')
...
blue_line_ncar = mlines.Line2D([],[] , color='blue',
                           label='NCAR ENS (10 members)',  linewidth = 2,marker = "o", markeredgecolor = 'none')

plt.legend(handles=[ blue_line_ncar, blue_line, red_line], loc = "lower right",prop={'size':10})
...
a = ax1.plot(freq_int_ncar[:,0],freq_int_ncar[:,3], linewidth = 2, c = 'blue', marker = "o", markeredgecolor = 'none')
ax1.errorbar(freq_int_ncar[:,0],freq_int_ncar[:,3], yerr= [abs(pr_unc75_int_ncar[0,:,1]-freq_int_ncar[:,3]), abs(pr_unc75_int_ncar[0,:,2]-freq_int_ncar[:,3])], c = 'b')
ax1.errorbar(freq_int_ncar[:,0],freq_int_ncar[:,0], yerr= [abs(pr_con75_int_ncar[0,:,1]-freq_int_ncar[:,0]), abs(pr_con75_int_ncar[0,:,2]-freq_int_ncar[:,0])], c = 'b')
...
a.grid(True)
plt.bar(freq_pac_ncar[:,0]-0.025,freq_pac_ncar[:,2],width = .025, color = 'blue', edgecolor ='none', align='center')
plt.bar(x_x,freq_pac[:,2],width = .025, color = 'green', edgecolor ='none', align='center')
plt.bar(x_x+0.025,freq_sref_bin_pac[:,2],width = .025, color = 'gold', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
...
b.grid(True)
plt.bar(freq_int_ncar[:,0]-0.025,freq_int_ncar[:,2],width = .025, color = 'blue', edgecolor ='none', align='center')
plt.bar(x_x,freq_int[:,2],width = .025, color = 'green', edgecolor ='none', align='center')
plt.bar(x_x+0.025,freq_sref_bin_int[:,2],width = .025, color = 'gold', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
plt.ylabel('# Forecasts', fontsize = 13)
plt.xlabel('Forecast Probability',fontsize = 13)
plt.xticks(np.arange(0,1.0001,.1), fontsize = 13)
...
plt.savefig("/uufs/chpc.utah.edu/common/home/u1013082/public_html/ms_thesis_plots/reliability_diagram_ncar_sref_arw_sref_nmb_interp_bin_percentile_85_pac_int_jim.pdf")                               
plt.close(fig)        
