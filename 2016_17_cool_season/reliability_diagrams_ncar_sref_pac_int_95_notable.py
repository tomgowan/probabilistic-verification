...
plt.text(.15,.06,'No Resolution (Climatology)',rotation = 0, fontsize = 13)
...
a.grid(True)
plt.bar(freq_pac[:,0]-0.015,freq_pac[:,5],width = .03, color = 'blue', edgecolor ='none', align='center')
plt.bar(freq_pac[:,0]+0.015,freq_sref_bin_pac[:,6],width = .03, color = 'red', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
...
b.grid(True)
plt.bar(freq_int[:,0]-0.015,freq_int[:,5],width = .03, color = 'blue', edgecolor ='none', align='center')
plt.bar(freq_int[:,0]+0.015,freq_sref_bin_int[:,6],width = .03, color = 'red', edgecolor ='none', align='center')
plt.xlim([-0.04,1.04])
plt.ylabel('# Forecasts', fontsize = 13)
plt.xlabel('Forecast Probability',fontsize = 13)
plt.xticks(np.arange(0,1.0001,.1), fontsize = 13)
...
plt.savefig("../../../public_html/reliability_diagram_sref_ncar_interp_bin_percentile_95_pac_int_notable.pdf")                               
