...
links = ["/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/snotel_precip_2016_2017_qc.csv", 
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/ncarens_precip_12Zto12Z_upper85_prob_interp_percentiles_int_non_bias_corrected.txt",
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/ncarens_precip_12Zto12Z_upper95_prob_interp_percentiles_int_non_bias_corrected.txt",
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/sref_precip_12Zto12Z_upper85_prob_interp_percentiles_int_non_bias_corrected.txt",
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/sref_precip_12Zto12Z_upper95_prob_interp_percentiles_int_non_bias_corrected.txt"]
...
###### Save Variables #######
#Frequency data
np.save('ncar_percentile_prob_int_non_bias_corrected', freq)
np.save('sref_percentile_prob_int_non_bias_corrected', freq_sref_bin)
#Skill Score data
np.save('ncar_percentile_prob_bss_int_non_bias_corrected', bssf)
np.save('sref_percentile_prob_bss_int_non_bias_corrected', bssf_sref)
#Uncertainty data
#np.save('ncar_sref_percentile_prob_uncertainty_con75_int', pr_con75)
#np.save('ncar_sref_percentile_prob_uncertainty_unc75_int', pr_unc75)
#np.save('ncar_sref_percentile_prob_uncertainty_con90_int', pr_con90)
#np.save('ncar_sref_percentile_prob_uncertainty_unc90_int', pr_unc90)
...
#
#
#plt.savefig("../../../public_html/reliability_diagram_sref_ncar_interp_bin_percentile_85_95_int.pdf")                               
#        
#     
#          
#          
